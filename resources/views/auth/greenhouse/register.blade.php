        ...
        <div class="relative w-full max-w-6xl">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-8 md:p-12">
                ...
                <div class="text-center mb-12">
                    <div
                        class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-green-600 to-emerald-600 rounded-3xl mb-8 shadow-lg">
                ...
                <!-- Registration Form -->
                <form method="POST" action="{{ route('register.greenhouse') }}" enctype="multipart/form-data"
                      class="space-y-10">
                    @csrf
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input
                                        ...
                                        name="name"
                                        value="{{ old('name') }}"
                                        class="block w-full pr-12 py-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:bg-white transition-all duration-200 text-right placeholder:text-slate-400 @error('name') border-red-500 bg-red-50 @enderror"
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <select
                                    id="substrate_type"
                                    name="substrate_type"
                                    class="block w-full py-4 px-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:bg-white transition-all duration-200 text-right @error('substrate_type') border-red-500 bg-red-50 @enderror">
                                    <option value="">بستر را انتخاب کنید</option>
                                    @foreach ($substrates as $substrate)
                                        <option
                                            value="{{ $substrate }}" {{ old('substrate_type') == $substrate ? 'selected' : '' }}>{{ $substrate }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="space-y-2">
                                ...
                                <select
                                    id="product_type"
                                    name="product_type"
                                    class="block w-full py-4 px-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:bg-white transition-all duration-200 text-right @error('product_type') border-red-500 bg-red-50 @enderror">
                                    <option value="">محصول را انتخاب کنید</option>
                                    @foreach ($productTypes as $productType)
                                        <option
                                            value="{{ $productType }}" {{ old('product_type') == $productType ? 'selected' : '' }}>{{ $productType }}</option>
                                    @endforeach
                                </select>
                                @error('product_type')
                                <div class="flex items-center gap-2 text-red-600 text-sm mt-2">
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input
                                        ...
                                        name="meterage"
                                        value="{{ old('meterage') }}"
                                        class="block w-full pr-12 py-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:bg-white transition-all duration-200 text-right placeholder:text-slate-400 @error('meterage') border-red-500 bg-red-50 @enderror"
                            ...
                            <div class="space-y-2">
                                ...
                                <select
                                    ...
                                    class="block w-full py-4 px-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:bg-white transition-all duration-200 text-right @error('greenhouse_status') border-red-500 bg-red-50 @enderror">
                                    <option value="">وضعیت را انتخاب کنید</option>
                                    @foreach ($greenhouseStatuses as $greenhouseStatus)
                                        <option
                                            value="{{ $greenhouseStatus }}" {{ old('greenhouse_status') == $greenhouseStatus ? 'selected' : '' }}>{{ $greenhouseStatus }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('construction_date') }}"
                                        class="block w-full pr-12 py-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:bg-white transition-all duration-200 text-right placeholder:text-slate-400 @error('construction_date') border-red-500 bg-red-50 @enderror"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input
                                        ...
                                        class="block w-full pr-12 py-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:bg-white transition-all duration-200 text-right placeholder:text-slate-400 @error('operation_date') border-red-500 bg-red-50 @enderror"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input
                                        ...
                                        class="block w-full pr-12 py-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all duration-200 text-right placeholder:text-slate-400 @error('owner_name') border-red-500 bg-red-50 @enderror"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input
                                        ...
                                        class="block w-full pr-12 py-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all duration-200 text-right placeholder:text-slate-400 @error('owner_national_id') border-red-500 bg-red-50 @enderror"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input
                                        ...
                                        class="block w-full pr-12 py-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all duration-200 text-left placeholder:text-slate-400 @error('owner_phone') border-red-500 bg-red-50 @enderror"
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <select
                                    id="province_id"
                                    name="province_id"
                                    class="province-select block w-full py-4 px-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:bg-white transition-all duration-200 text-right @error('province_id') border-red-500 bg-red-50 @enderror"
                                    required>
                            ...
                            <div class="space-y-2">
                                ...
                                <select
                                    id="city_id"
                                    name="city_id"
                                    class="city-select block w-full py-4 px-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:bg-white transition-all duration-200 text-right @error('city_id') border-red-500 bg-red-50 @enderror"
                                    required>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input
                                    ...
                                    dir="ltr"
                                    class="block w-full pr-12 py-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:bg-white transition-all duration-200 text-left placeholder:text-slate-400 @error('location_link') border-red-500 bg-red-50 @enderror"
                ...
                <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/40">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <a href="{{ route('contact.us') }}"
                           class="text-green-600 hover:text-green-700 font-medium transition-colors flex items-center gap-2">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            provinceSelect.addEventListener('change', function () {
                ...
                if (provinceId) {
                    fetch(`{{ route('register.greenhouse.cities', '') }}/${provinceId}`)
        ...
        `;
            ...
            // Restore selected city if old input exists
            @if(old('province_id'))
            const oldProvinceId = {{ old('province_id') }};
            const oldCityId = {{ old('city_id', 'null') }};

            if (oldProvinceId) {
                fetch(`{{ route('register.greenhouse.cities', '') }}/${oldProvinceId}`)
                    .then(response => response.json())
                    .then(data => {
                        if (data.success) {
                            let options = '<option value="">شهر را انتخاب کنید</option>';
                            data.cities.forEach(city => {
                                const selected = oldCityId == city.id ? 'selected' : '';
