    ...
    <div class="bg-gray-50 rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" id="fname" name="fname" value="{{ $organization->fname }}" required
            ...
            <div>
                ...
                <input type="text" id="lname" name="lname" value="{{ $organization->lname }}" required
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 transition-all duration-200"
                       placeholder="احمدی">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" id="national_id" name="national_id" value="{{ $organization->national_id }}" required
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 transition-all duration-200"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" id="organization_level" name="organization_level"
                       value="{{ $organization->organization_level }}" required
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 transition-all duration-200"
    ...
    <div class="bg-gray-50 rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" id="province" name="province" value="{{ $organization->province }}" required
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 transition-all duration-200"
                       placeholder="فارس">
            </div>
            ...
            <div>
                ...
                <input type="text" id="city" name="city" value="{{ $organization->city }}" required
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 transition-all duration-200"
                       placeholder="شیراز">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea id="address" name="address" rows="3" required
                          class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 transition-all duration-200"
                          placeholder="بلوار پاسداران، ...">{{ $organization->address }}</textarea>
            </div>
            ...
            <div>
                ...
                <input type="text" id="postal" name="postal" value="{{ $organization->postal }}" required
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 transition-all duration-200"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="tel" id="landline_number" name="landline_number"
                       value="{{ $organization->landline_number }}"
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 transition-all duration-200"
            ...
            <div>
                ...
                <input type="tel" id="phone_number" name="phone_number" value="{{ $organization->phone_number }}"
                       required
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 transition-all duration-200"
            ...
            <div>
                ...
                <select id="status" name="status"
                    ...
                    @foreach($statuses as $status)
                        <option
                            value="{{ $status['name'] }}" {{ $organization->status === $status['name'] ? 'selected' : '' }}>{{ $status['title'] }}</option>
                    @endforeach
                </select>
            </div>
        </div>
