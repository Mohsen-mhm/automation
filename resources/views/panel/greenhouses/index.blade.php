...
@section('title', 'مدیریت گلخانه‌ها')
    ...
    <div class="space-y-8">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 flex items-center">
                        <div
                            class="w-10 h-10 bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl flex items-center justify-center ml-3">
                    ...
                    <p class="text-gray-600 mt-1">مدیریت اطلاعات گلخانه‌های ثبت شده در سیستم</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-green-100 text-sm">کل گلخانه‌ها</p>
                        <p class="text-2xl font-bold" id="totalGreenhouses">-</p>
                    </div>
            ...
            <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-2xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-emerald-100 text-sm">گلخانه‌های فعال</p>
                        <p class="text-2xl font-bold" id="activeGreenhouses">-</p>
                    </div>
                    <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-gradient-to-r from-amber-500 to-amber-600 rounded-2xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold" id="pendingGreenhouses">-</p>
                    </div>
                    <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-200 bg-gray-50">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        <h2 class="text-lg font-semibold text-gray-900">لیست گلخانه‌ها</h2>
                        <span
                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                           <span id="greenhouseCount">-</span> گلخانه
                       </span>
                    </div>
                    ...
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <div class="relative">
                            ...
                            <input type="search" id="searchInput"
                                   class="block w-64 pr-10 pl-4 py-2.5 text-sm text-gray-900 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200"
                                   placeholder="جستجو در گلخانه‌ها...">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-x-auto">
                <table id="greenhousesTable" class="w-full">
                    <thead>
    ...
    @can(\App\Models\Greenhouse::GREENHOUSE_CREATE)
        ...
        <div id="createModal"
            ...
            <div
                ...
                <!-- Modal Header -->
                <div
                    class="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-emerald-500 to-green-600">
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <h3 class="text-xl font-semibold text-white">افزودن گلخانه جدید</h3>
                    </div>
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <h3 class="text-xl font-semibold text-white">ویرایش گلخانه</h3>
                    </div>
        ...
        <div
            ...
            <div
                ...
                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <h3 class="text-xl font-semibold text-white">اطلاعات گلخانه</h3>
                </div>
            ...
            <div class="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4">
                ...
                <div
                    ...
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <h3 class="text-xl font-semibold text-white">حذف گلخانه</h3>
                    </div>
                ...
                <div class="p-6 text-center">
                    ...
                    <p class="text-gray-600 mb-6">آیا مطمئن هستید که می‌خواهید این گلخانه را حذف کنید؟ این عمل قابل
                        بازگشت
                        نیست.</p>
...
@push('styles')
    ...
    <style>
        ...
        #greenhousesTable tbody tr {
            transition: all 0.2s ease;
        }

        #greenhousesTable tbody tr:hover {
...
@push('scripts')
    ...
    <script>
        ...
        function initializeDataTable() {
            greenhousesTable = $('#greenhousesTable').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ordering: false,
                ...
                lengthChange: false,
                ajax: {
                    url: '{{ route("panel.greenhouses.data") }}',
                    type: 'GET',
                    data: function (d) {
                        d.search = {
                ...
                columns: [
                    {
                        ...
                        render: function (data, type, row, meta) {
                            return `<span class="inline-flex items-center justify-center w-8 h-8 text-xs font-medium text-green-700 bg-green-100 rounded-full">${data}</span>`;
                        }
                    },
                    {
                        data: 1,
                    ...
                    {data: 2, name: 'licence_number', orderable: false},
                    {data: 3, name: 'meterage', orderable: false},
                    {data: 4, name: 'owner_name', orderable: false},
                    {data: 5, name: 'owner_phone', orderable: false},
                    {data: 6, name: 'owner_national_id', orderable: false},
                    {
                        data: 7,
                        name: 'status',
                        orderable: false,
                    ...
                    {data: 8, name: 'created_at', orderable: false},
                    {
                        data: 9,
                        name: 'actions',
                        orderable: false,
        ...
        function bindEventHandlers() {
            ...
            $('#searchInput').on('keyup', debounce(function () {
                greenhousesTable.draw();
            }, 300));

            // Page length change
            $('#pageLength').on('change', function () {
                const newLength = parseInt($(this).val());
                greenhousesTable.page.len(newLength).draw();
            });
        ...
        function bindActionButtons() {
            $('.btn-show').off('click').on('click', function () {
                const greenhouseId = $(this).data('greenhouse-id');
                showGreenhouse(greenhouseId);
            });

            $('.btn-edit').off('click').on('click', function () {
                const greenhouseId = $(this).data('greenhouse-id');
                editGreenhouse(greenhouseId);
            });
            ...
            if (info.pages > 1) {
                ...
                for (let i = startPage; i <= endPage; i++) {
                    ...
                    paginationHtml += `<button type="button" onclick="goToPage(${i})"
                       class="px-3 py-2 text-sm font-medium transition-colors duration-200 border ${isActive ? 'text-green-600 bg-green-50 border-green-300' : 'text-gray-500 bg-white border-gray-300 hover:text-gray-700 hover:bg-gray-50'}">
                       ${i + 1}
                   </button>`;
                }
        ...
        function goToPage(pageNumber) {
            greenhousesTable.page(pageNumber).draw('page');
        }

        function updateStats() {
            // This would typically fetch stats from an API endpoint
            $('#totalGreenhouses').text($('#greenhouseCount').text() || '0');
            $('#activeGreenhouses').text('0'); // Would be calculated from API
            $('#pendingGreenhouses').text('0'); // Would be calculated from API
        }

        function refreshTable() {
            greenhousesTable.ajax.reload(null, false);
            updateStats();
            showToast('جدول با موفقیت بروزرسانی شد', 'success');
        }

        function exportData() {
            window.location.href = '{{ route("panel.greenhouses.export") }}?format=excel';
        ...
        function openCreateModal() {
           ...
           `);
            ...
            $.get('{{ route("panel.greenhouses.create") }}')
        ...
        function editGreenhouse(greenhouseId) {
           ...
           `);
            ...
            $.get(`{{ route('panel.greenhouses.index') }}/${greenhouseId}/edit`)
                .done(function (response) {
                    if (response.success) {
        ...
        function showGreenhouse(greenhouseId) {
           ...
           `);
            ...
            $.get(`{{ route('panel.greenhouses.index') }}/${greenhouseId}`)
                .done(function (response) {
                    if (response.success) {
        ...
        function confirmDelete() {
            if (!currentGreenhouseId) return;

            $.ajax({
                url: `{{ route('panel.greenhouses.index') }}/${currentGreenhouseId}`,
                type: 'DELETE',
                data: {
        ...
        function submitForm(form) {
            ...
            const url = isEdit ?
                `{{ route('panel.greenhouses.index') }}/${currentGreenhouseId}` :
                '{{ route("panel.greenhouses.store") }}';
        ...
        function loadCities(provinceId, citySelect) {
            ...
            $.get('{{ route("panel.greenhouses.cities-by-province", ":province") }}'.replace(':province', provinceId))
                .done(function (response) {
                    if (response.success) {
        ...
        function extractCoordinates(url, form) {
            $.post('{{ route("panel.greenhouses.coordinates") }}', {
                url: url,
                _token: $('meta[name="csrf-token"]').attr('content')
            })
                .done(function (response) {
