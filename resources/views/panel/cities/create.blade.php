...
<form id="cityForm">
    ...
    <div class="mb-6">
        ...
        <p class="mt-2 text-xs text-gray-500">
            ابتدا استان مربوطه را انتخاب کنید
        </p>
    </div>
    ...
    <div class="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-xl">
        ...
        <div class="space-y-2 text-sm">
            <div class="flex items-center justify-between">
                ...
                <span class="font-medium text-emerald-900" id="previewProvince">انتخاب نشده</span>
            </div>
            <div class="flex items-center justify-between">
                <span class="text-emerald-700">نام شهر:</span>
                <span class="font-medium text-emerald-900" id="previewName">-</span>
            </div>
            <div class="flex items-center justify-between">
                <span class="text-emerald-700">ترتیب نمایش:</span>
                <span class="font-medium text-emerald-900" id="previewSort">0</span>
            </div>
            <div class="flex items-center justify-between">
                <span class="text-emerald-700">وضعیت:</span>
                <span class="font-medium text-emerald-900" id="previewStatus">فعال</span>
            </div>
        </div>
    </div>
