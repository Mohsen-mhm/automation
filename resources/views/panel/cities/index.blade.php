    ...
    <div class="space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">مدیریت شهرهای کشور</p>
                </div>
                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                    @can(\App\Models\City::CITY_CREATE)
                        <!-- Add New City Button -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-2xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-emerald-100 text-sm">کل شهرها</p>
            ...
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-blue-100 text-sm">شهرهای فعال</p>
                        <p class="text-2xl font-bold" id="activeCities">-</p>
                    </div>
                    <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-purple-100 text-sm">کل استان‌ها</p>
            ...
            <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-orange-100 text-sm">شهر انتخاب شده</p>
                        <p class="text-lg font-bold" id="selectedProvince">همه استان‌ها</p>
                    </div>
                    <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-200 bg-gray-50">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        <h2 class="text-lg font-semibold text-gray-900">لیست شهرها</h2>
                        <span
                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800">
                            <span id="cityCount">-</span> شهر
                        </span>
                    </div>
                    ...
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <div class="relative">
                            ...
                            <input type="search" id="searchInput"
                                   class="block w-64 pr-10 pl-4 py-2 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200"
            ...
            <div class="overflow-x-auto">
                <table id="citiesTable" class="w-full">
                    <thead>
        ...
        <div
            ...
            <div
                ...
                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <h3 class="text-xl font-semibold text-white" id="modalTitle">مدیریت شهر</h3>
                </div>
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-md w-full">
            ...
            <div class="flex items-center justify-between p-6 border-b border-gray-200">
                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">حذف شهر</p>
                    </div>
                </div>
            ...
            <div class="p-6">
                <div class="text-center mb-6">
                    <p class="text-gray-700 mb-2">آیا از حذف شهر <span id="deleteCityName" class="font-semibold"></span>
                        مطمئن هستید؟</p>
    ...
    <script>
            ...
            citiesTable = $('#citiesTable').DataTable({
                ...
                ajax: {
                    ...
                    data: function (d) {
                        ...
                        d.province_id = $('#provinceFilter').val();
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function (data) {
                            return `<div class="text-gray-700">${data}</div>`;
                        }
                    },
                    {
                        data: 3,
                ...
                language: {
                    ...
                    emptyTable: "هیچ شهری ثبت نشده است",
        ...
        function bindEventHandlers() {
            ...
            $('#provinceFilter').on('change', function () {
                ...
                $('#selectedProvince').text(selectedProvince || 'همه استان‌ها');
                citiesTable.draw();
            });
            ...
            $('#pageLength').on('change', function () {
                ...
                citiesTable.page.len(newLength).draw();
            });
        ...
        function showCreateModal() {
            $('#modalTitle').text('افزودن شهر جدید');
        ...
        function editCity(cityId) {
            ...
            $.get(`{{ route('panel.cities.index') }}/${cityId}/edit`)
                .done(function (response) {
                    if (response.success) {
                        $('#modalBody').html(response.html);
                        currentCityId = response.city_id;
                        bindModalFormEvents();
                    }
                })
                .fail(function () {
        ...
        function bindModalFormEvents() {
            $('#cityForm').off('submit').on('submit', function (e) {
                e.preventDefault();
                submitForm();
            });
        }
        ...
        function submitForm() {
            ...
            let url = '{{ route("panel.cities.store") }}';
            let method = 'POST';

            if (currentCityId) {
                url = `{{ route('panel.cities.index') }}/${currentCityId}`;
        ...
        function toggleCityStatus(cityId) {
            $.post(`{{ route('panel.cities.index') }}/${cityId}/toggle-status`, {
        ...
        function deleteCity(cityId) {
            ...
            $.ajax({
                url: `{{ route('panel.cities.index') }}/${cityId}`,
                type: 'DELETE',
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content')
                },
                ...
                error: function (xhr) {
                    const message = xhr.responseJSON?.message || 'خطا در حذف شهر';
                    showToast(message, 'error');
                },
                complete: function () {
        ...
        function goToPage(pageNumber) {
            citiesTable.page(pageNumber).draw('page');
        }

        function updateStats() {
            $.get('{{ route("panel.cities.data") }}', {length: -1})
                .done(function (response) {
                    $('#totalCities').text(response.recordsTotal || 0);
                    ...
                    if (response.data && response.data.length > 0) {
                        response.data.forEach(function (row) {
                            ...
                            // Add province to set (column index 2)
                            if (row[2]) {
                                provinceSet.add(row[2]);
                            }
                        });
                    }

                    $('#activeCities').text(activeCount);
                    $('#totalProvinces').text(provinceSet.size);
                });
        }
        ...
        function exportData() {
            ...
            let url = '{{ route("panel.cities.export") }}?format=excel';
