...
@section('title', 'مدیریت اتوماسیون‌ها')

@section('content')
    <div class="space-y-8">
        <!-- Toast Container -->
        <div id="toastContainer" class="fixed bottom-5 left-5 z-50 space-y-3"></div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">مدیریت سیستم‌های اتوماسیون گلخانه‌ها</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-2xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-emerald-100 text-sm">کل اتوماسیون‌ها</p>
                        <p class="text-2xl font-bold" id="totalAutomations">-</p>
                    </div>
            ...
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-blue-100 text-sm">سیستم‌های فعال</p>
                        <p class="text-2xl font-bold" id="activeAutomations">-</p>
                    </div>
                    <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-gradient-to-r from-amber-500 to-amber-600 rounded-2xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold" id="pendingAutomations">-</p>
                    </div>
                    <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-200 bg-gray-50">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        <h2 class="text-lg font-semibold text-gray-900">لیست اتوماسیون‌ها</h2>
                        <span
                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800">
                            <span id="automationCount">-</span> اتوماسیون
                        </span>
                    </div>
            ...
            <div class="overflow-x-auto">
                <table id="automationsTable" class="w-full">
                    <thead>
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <h3 class="text-xl font-semibold text-white">افزودن اتوماسیون جدید</h3>
                    </div>
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <h3 class="text-xl font-semibold text-white">ویرایش اتوماسیون</h3>
                    </div>
        ...
        <div
            ...
            <div
                ...
                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <h3 class="text-xl font-semibold text-white">اطلاعات اتوماسیون</h3>
                </div>
    ...
    @can(\App\Models\Automation::AUTOMATION_DELETE)
            ...
            <div class="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4">
                ...
                <div
                    ...
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <h3 class="text-xl font-semibold text-white">حذف اتوماسیون</h3>
                    </div>
                ...
                <div class="p-6 text-center">
                    ...
                    <p class="text-gray-600 mb-6">آیا مطمئن هستید که می‌خواهید این اتوماسیون را حذف کنید؟ این عمل قابل بازگشت
                        نیست.</p>
...
@push('scripts')
    ...
    <script>
        ...
        function initializeDataTable() {
            automationsTable = $('#automationsTable').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ordering: false,
                ...
                lengthChange: false,
                ajax: {
                    url: '{{ route("panel.automations.data") }}',
                    type: 'GET',
                    data: function (d) {
                        d.search = {
                ...
                columns: [
                    ...
                    {
                        data: 2,
                        name: 'climate_company',
                        orderable: false,
                        render: function (data, type, row) {
                            return data;
                        }
                    },
                    {data: 3, name: 'climate_date', orderable: false},
                    {
                        data: 4,
                        name: 'feeding_company',
                        orderable: false,
                        render: function (data, type, row) {
                            return data;
                        }
                    },
                    {data: 5, name: 'feeding_date', orderable: false},
                    {
                        data: 6,
                        name: 'status',
                        orderable: false,
        ...
        function bindEventHandlers() {
            ...
            $('#searchInput').on('keyup', debounce(function () {
                automationsTable.draw();
            }, 300));

            // Page length change
            $('#pageLength').on('change', function () {
                const newLength = parseInt($(this).val());
                automationsTable.page.len(newLength).draw();
            });
        ...
        function goToPage(pageNumber) {
            automationsTable.page(pageNumber).draw('page');
        }

        function updateStats() {
            // This would typically fetch stats from an API endpoint
            $('#totalAutomations').text($('#automationCount').text() || '0');
            $('#activeAutomations').text('0'); // Would be calculated from API
            $('#pendingAutomations').text('0'); // Would be calculated from API
        }

        function refreshTable() {
            automationsTable.ajax.reload(null, false);
            updateStats();
            showToast('جدول با موفقیت بروزرسانی شد', 'success');
        }

        function exportData() {
            window.location.href = '{{ route("panel.automations.export") }}?format=excel';
        ...
        function openCreateModal() {
           ...
           `);
            ...
            $.get('{{ route("panel.automations.create") }}')
        ...
        function editAutomation(automationId) {
           ...
           `);
            ...
            $.get(`{{ route('panel.automations.index') }}/${automationId}/edit`)
                .done(function (response) {
                    if (response.success) {
        ...
        function showAutomation(automationId) {
           ...
           `);
            ...
            $.get(`{{ route('panel.automations.index') }}/${automationId}`)
                .done(function (response) {
                    if (response.success) {
        ...
        function confirmDelete() {
            ...
            $.ajax({
                url: `{{ route('panel.automations.index') }}/${currentAutomationId}`,
                type: 'DELETE',
                data: {
        ...
        function submitForm(form) {
            ...
            const url = isEdit ?
                `{{ route('panel.automations.index') }}/${currentAutomationId}` :
                '{{ route("panel.automations.store") }}';
