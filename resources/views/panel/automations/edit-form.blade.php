        ...
        <div>
            ...
            <select id="greenhouse_id" name="greenhouse_id" required
                ...
                @foreach($greenhouses as $greenhouse)
                    <option value="{{ $greenhouse->id }}" {{ $automation->greenhouse_id == $greenhouse->id ? 'selected' : '' }}>
                        {{ $greenhouse->name }} - {{ $greenhouse->licence_number }}
                    </option>
                @endforeach
            </select>
        </div>
    ...
    <div class="bg-gray-50 rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <select id="climate_company_id" name="climate_company_id"
                    ...
                    @foreach($climate_companies as $company)
                        <option value="{{ $company->id }}" {{ $automation->climate_company_id == $company->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <input type="text" id="climate_date" name="climate_date" value="{{ $climate_date }}"
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 transition-all duration-200"
            ...
            <div>
                ...
                <input type="url" id="climate_api_link" name="climate_api_link" value="{{ $automation->climate_api_link }}"
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 transition-all duration-200"
            ...
            <div>
                ...
                <input type="text" id="climate_linked_date" name="climate_linked_date" value="{{ $climate_linked_date }}"
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 transition-all duration-200"
    ...
    <div class="bg-gray-50 rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <select id="feeding_company_id" name="feeding_company_id"
                    ...
                    @foreach($feeding_companies as $company)
                        <option value="{{ $company->id }}" {{ $automation->feeding_company_id == $company->id ? 'selected' : '' }}>
                            {{ $company->name }} - {{ $company->national_id }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="text" id="feeding_date" name="feeding_date" value="{{ $feeding_date }}"
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white text-gray-900 transition-all duration-200"
                       placeholder="1401/03/25">
            </div>
            ...
            <div>
                ...
                <input type="url" id="feeding_api_link" name="feeding_api_link" value="{{ $automation->feeding_api_link }}"
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white text-gray-900 transition-all duration-200"
            ...
            <div>
                ...
                <input type="text" id="feeding_linked_date" name="feeding_linked_date" value="{{ $feeding_linked_date }}"
                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white text-gray-900 transition-all duration-200"
                       placeholder="1401/03/25">
            </div>
        </div>
            ...
            <div>
                ...
                <select id="status" name="status"
                    ...
                    @foreach($statuses as $status)
                        <option value="{{ $status['name'] }}" {{ $automation->status === $status['name'] ? 'selected' : '' }}>
                            {{ $status['title'] }}
                        </option>
                    @endforeach
                </select>
