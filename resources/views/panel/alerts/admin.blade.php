...
@section('title', 'مدیریت تنظیمات محدوده‌ها')
        ...
        <div class="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl p-6 text-white">
            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4 rtl:space-x-reverse mt-2 text-emerald-100">
                        <span>مالک: {{ $greenhouse->owner_name }}</span>
                        <span>•</span>
                        <span>{{ $greenhouse->province?->name }}, {{ $greenhouse->city?->name }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-6">
                @include('panel.alerts.form', [
                    'action' => route('panel.alerts.admin.store', $id),
                    'method' => 'POST',
                    'alert' => $alert,
                    'isAdmin' => true
                ])
