<form class="w-full mb-2" wire:submit="update" enctype="multipart/form-data">
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        <div>
            <x-persian-datepicker wirePropertyName="operation_date" label="تاریخ احداث"
                                  showFormat="jYYYY/jMM/jDD" returnFormat="X" :required="false"
        ...
        <div>
            <x-persian-datepicker wirePropertyName="construction_date" label="تاریخ بهره برداری"
                                  showFormat="jYYYY/jMM/jDD" returnFormat="X" :required="false"
                                  :defaultDate="date('Y-m-d H:i:s')"
                                  :setNullInput="true" :withTime="false" :withTimeSeconds="false"/>
            @error('construction_date')
    ...
    <div class="grid gap-6 mb-6 mt-4 md:grid-cols-2">
        ...
        <div class="w-full flex justify-center items-center">
            <div class="w-full flex flex-col justify-center items-center text-center">
                <span class="w-full mb-2 text-center font-bold">تصویر پروانه بهره برداری فعلی</span>
                <img src="{{ asset($old_operation_licence) }}" style="max-width: 150px"
                     alt="Operation Licence">
            </div>
        </div>
    </div>
    ...
    <div class="grid gap-6 mb-6 mt-4 md:grid-cols-2">
        ...
        <div class="w-full flex justify-center items-center">
            <div class="w-full flex flex-col justify-center items-center text-center">
                <span class="w-full mb-2 text-center font-bold">تصویر یا لوگو گلخانه فعلی</span>
                <img src="{{ asset($old_image) }}" style="max-width: 150px"
                     alt="Greenhouse logo or image">
            </div>
        </div>
    </div>
