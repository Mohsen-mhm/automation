<form class="w-full mb-2 mt-12" wire:submit="update" enctype="multipart/form-data">
    @csrf
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        ...
        <div>
            <x-persian-datepicker wirePropertyName="registration_date" label="تاریخ ثبت"
                                  showFormat="jYYYY/jMM/jDD" returnFormat="X" :required="true"
                                  :defaultDate="date('Y-m-d H:i:s')"
                                  :setNullInput="true" :withTime="false" :withTimeSeconds="false"/>
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2 flex items-center">
        <div>
            ...
            <input wire:model.live="company_logo" accept="image/*"
        ...
        <div class="w-full flex justify-center items-center">
            <div class="w-full flex flex-col justify-center items-center text-center">
                <span class="w-full mb-2 text-center font-bold">لوگوی فعلی</span>
                <img src="/{{ asset($old_company_logo) }}" style="max-width: 150px" alt="Company logo">
            </div>
        </div>
    </div>
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2 flex items-center">
        <div>
            ...
            <input wire:model.live="operation_licence" accept="image/*"
                   class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none transition"
        ...
        <div class="w-full flex justify-center items-center">
            <div class="w-full flex flex-col justify-center items-center text-center">
                <span class="w-full mb-2 text-center font-bold">مجوز فناوری یا پروانه بهره برداری فعلی</span>
                <img src="/{{ asset($old_operation_licence) }}" style="max-width: 150px" alt="Company logo">
            </div>
        </div>
    </div>
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2 flex items-center">
        <div>
            ...
            <input wire:model.live="brand_logo" accept="image/*"
                   class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none transition"
        ...
        <div class="w-full flex justify-center items-center">
            <div class="w-full flex flex-col justify-center items-center text-center">
                <span class="w-full mb-2 text-center font-bold">علامت تجاری فعلی</span>
                <img src="/{{ asset($old_brand_logo) }}" style="max-width: 150px" alt="Brand logo">
            </div>
        </div>
    </div>
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2 flex items-center">
        <div>
            ...
            <input wire:model.live="trademark_certificate" accept="image/*"
                   class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none transition"
        ...
        <div class="w-full flex justify-center items-center">
            <div class="w-full flex flex-col justify-center items-center text-center">
                <span class="w-full mb-2 text-center font-bold">گواهی ثبت علامت تجاری فعلی</span>
                <img src="/{{ asset($old_trademark_certificate) }}" style="max-width: 150px"
