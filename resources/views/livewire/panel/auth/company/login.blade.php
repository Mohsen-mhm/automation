<div class="w-full">
    <div
        class="min-h-screen relative flex items-start justify-center p-4">
                    ...
                    <div
                        ...
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-6m-4 0H3m2-16v16m6-16v16"/>
                        </svg>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-emerald-700 leading-relaxed">
                                ابتدا شناسه ملی شرکت و شماره همراه رابط را وارد کنید، سپس کد تایید ارسالی را دریافت
                                نمایید.
                            </p>
                        </div>
                    </div>
