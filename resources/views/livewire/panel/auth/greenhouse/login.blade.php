        ...
        <div class="relative w-full">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-8 md:p-10">
                ...
                <div class="text-center mb-8">
                    <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl mb-6 shadow-lg">
                        ...
                        <div class="flex items-stretch gap-3">
                            ...
                            <div class="relative flex-1 group">
                                ...
                                <input
                                    ...
                                    class="block w-full pr-12 py-4 text-slate-900 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:bg-white transition-all duration-200 text-left placeholder:text-slate-400 disabled:opacity-50 disabled:cursor-not-allowed"
                                    placeholder="902150"
                                    disabled
                                    required>
                            </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-green-700 leading-relaxed">
                                کد ملی و شماره همراه ثبت شده در سامانه را وارد کنید. پس از دریافت کد تایید، وارد پنل مدیریت گلخانه خود شوید.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center mt-6">
                <p class="text-sm text-slate-500">
                    مشکل در ورود دارید؟
                    <a href="{{ route('contact.us') }}" class="text-green-600 hover:text-green-700 font-medium transition-colors">تماس با پشتیبانی</a>
                </p>
            </div>
        </div>
