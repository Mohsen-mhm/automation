<div class="w-full flex flex-col justify-center items-center pr-7">
    <div
        ...
        <h5 class="mb-8 text-2xl font-semibold tracking-tight text-gray-900">ورود گلخانه داران</h5>
        <form class="w-full mb-2" wire:submit="login">
            ...
            <div class="w-full flex justify-center items-center mt-8">
                <button type="submit"
                    class="focus:outline-none text-white font-bold bg-[#026B56] hover:bg-[#013328] focus:ring-4 focus:ring-[#026B56] rounded-lg px-5 py-2.5 me-2 mb-2 transition">ورود
                    به پنل</button>
            </div>
        </form>
    </div>
