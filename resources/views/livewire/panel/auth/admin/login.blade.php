<div class="w-full flex flex-col justify-center items-center pr-7">
    <div
        ...
        <h5 class="mb-8 text-2xl font-semibold tracking-tight text-gray-900">ورود</h5>
        <form class="w-full mb-2" wire:submit="login">
            <div class="mb-6">
                ...
                <input type="text" id="national_id" wire:model.live="national_id"
                       class="bg-gray-50 transition border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-[#026B56] focus:border-[#026B56] block w-full p-2.5"
            ...
            <div class="mt-7">
                ...
                <input type="text" id="phone_number" wire:model.live="phone_number"
                       class="text-left transition bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-[#026B56] focus:border-[#026B56] block w-full p-2.5"
            ...
            <div class="mt-7" wire:ignore.self>
                ...
                <div class="flex items-center mt-2">
                    <button
                        class="cursor-pointer transition flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-white bg-[#026B56] border border-gray-400 rounded-s-lg hover:bg-[#013328] focus:ring-2 focus:outline-none focus:ring-[#026B56]"
                        type="button" onclick="sendCode(this)">
                        ارسال کد ورود
                    </button>
                    <div class="relative w-full">
                        <input type="text" id="code-input" wire:model.blur="code"
                               class="block transition p-2.5 opacity-75 w-full z-20 text-sm text-left text-gray-900 bg-gray-50 rounded-e-lg border-s-0 border border-gray-400 focus:ring-[#026B56] focus:border-[#026B56]"
            ...
            <div class="w-full flex justify-center items-center mt-8">
                <button type="submit"
                        class="focus:outline-none text-white font-bold bg-[#026B56] hover:bg-[#013328] focus:ring-4 focus:ring-[#026B56] rounded-lg px-5 py-2.5 me-2 mb-2 transition">
                    ورود
                    به پنل
                </button>
            </div>
