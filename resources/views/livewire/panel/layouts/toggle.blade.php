...
<div class="md:hidden z-50">
    <button id="sidebarToggle"
        ...
        <!-- Tooltip -->
        <div
            class="absolute left-full ml-3 top-1/2 transform -translate-y-1/2 bg-gray-900 text-white text-sm px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none">
            منوی اصلی
            <div
