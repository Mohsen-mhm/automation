        ...
        <div class="p-6">
                ...
                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                    <div class="flex-1 min-w-0">
                        ...
                        @elseif(auth()->user()->hasRole(\App\Models\Role::COMPANY_ROLE))
                            ...
                            @endphp
                            <h3 class="text-black font-semibold truncate">شرکت {{ $company->name }}</h3>
                        ...
                        @elseif(auth()->user()->hasRole(\App\Models\Role::GREENHOUSE_ROLE))
                            ...
                            @endphp
                            <h3 class="text-black font-semibold truncate">{{ $greenhouse->name }}</h3>
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('panel.home') }}"
                   class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.home')) bg-white/20 shadow-lg @endif">
                    <div
                ...
                @can(\App\Models\Permission::PROFILE_INDEX)
                    <a href="{{ route('panel.profile') }}"
                       class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.profile')) bg-white/20 shadow-lg @endif">
                        <div
                ...
                @if(auth()->user()->isActive())
                    ...
                    @can(\App\Models\Config::CONFIG_INDEX)
                        <a href="{{ route('panel.configs.index') }}"
                           class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.configs.index')) bg-white/20 shadow-lg @endif">
                            <div
                    ...
                    @can(\App\Models\Role::ROLE_INDEX)
                        <a href="{{ route('panel.roles.index') }}"
                           class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.roles')) bg-white/20 shadow-lg @endif">
                            <div
                    ...
                    @can(\App\Models\Permission::PERMISSION_INDEX)
                        <a href="{{ route('panel.permissions.index') }}"
                           class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.permissions')) bg-white/20 shadow-lg @endif">
                            <div
                    ...
                    @can(\App\Models\User::USER_INDEX)
                        <a href="{{ route('panel.users.index') }}"
                           class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.users.index')) bg-white/20 shadow-lg @endif">
                            <div
                    ...
                    @can(\App\Models\Company::COMPANY_INDEX)
                        <a href="{{ route('panel.companies.index') }}"
                           class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.companies.index')) bg-white/20 shadow-lg @endif">
                            <div
                    ...
                    @can(\App\Models\Greenhouse::GREENHOUSE_INDEX)
                        <a href="{{ route('panel.greenhouses.index') }}"
                           class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.greenhouses')) bg-white/20 shadow-lg @endif">
                            <div
                    ...
                    @can(\App\Models\OrganizationUser::ORGAN_INDEX)
                        <a href="{{ route('panel.organizations.index') }}"
                           class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.organizations')) bg-white/20 shadow-lg @endif">
                            <div
                    ...
                    @can(\App\Models\Automation::AUTOMATION_INDEX)
                        <a href="{{ route('panel.automations.index') }}"
                           class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.automations')) bg-white/20 shadow-lg @endif">
                            <div
                    ...
                    @can(\App\Models\GreenhouseAlert::ALERT_INDEX)
                        <a href="{{ route('panel.alerts') }}"
                           class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.alerts')) bg-white/20 shadow-lg @endif">
                            <div
                    ...
                    @can(\App\Models\AboutUs::ABOUT_US_INDEX)
                        <a href="{{ route('panel.about.us.index') }}"
                           class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.about.us.index')) bg-white/20 shadow-lg @endif">
                            <div
                    ...
                    @can(\App\Models\ContactUs::CONTACT_US_INDEX)
                        <a href="{{ route('panel.contact-us.index') }}"
                           class="group flex items-center space-x-3 rtl:space-x-reverse px-4 py-3 rounded-xl transition-all duration-200 hover:bg-white/10 @if (\Illuminate\Support\Facades\Route::is('panel.contact-us')) bg-white/20 shadow-lg @endif">
                            <div
