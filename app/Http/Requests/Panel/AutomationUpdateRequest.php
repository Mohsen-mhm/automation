...
class AutomationUpdateRequest extends FormRequest
{
    ...
    {
        return Gate::allows(Automation::AUTOMATION_EDIT);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'climate_api_link' => ['nullable', 'string', new ValidUrl(), Rule::unique('automations', 'climate_api_link')->ignore($automation->id)],
            'climate_linked_date' => ['nullable', 'string'],
            'feeding_company_id' => ['nullable', 'exists:companies,id'],
            'feeding_date' => ['nullable', 'string'],
            'feeding_api_link' => ['nullable', 'string', new ValidUrl(), Rule::unique('automations', 'feeding_api_link')->ignore($automation->id)],
