...
class OrganizationUpdateRequest extends FormRequest
{
    ...
    {
        return Gate::allows(OrganizationUser::ORGAN_EDIT);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'national_id' => ['required', 'string', new ValidNationalCard(), Rule::unique('organization_users', 'national_id')->ignore($organization->id)],
