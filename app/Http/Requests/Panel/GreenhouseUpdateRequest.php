...
class GreenhouseUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return Gate::allows(Greenhouse::GREENHOUSE_EDIT);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'licence_number' => ['required', 'string', 'min:4', Rule::unique('greenhouses', 'licence_number')->ignore($greenhouse->id)],
